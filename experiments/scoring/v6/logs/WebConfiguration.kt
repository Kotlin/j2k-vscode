...
open class WebConfiguration : WebMvcConfigurer {
     ...
     */
    @Bean
    open fun localeResolver(): LocaleResolver = SessionLocaleResolver().apply {
     ...
     */
    @Bean
    open fun localeChangeInterceptor(): LocaleChangeInterceptor = LocaleChangeInterceptor().apply {
        setParamName("lang")
    }
