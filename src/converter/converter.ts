...
async function convertUsingOllama(javaCode: string, outputChannel: vscode.OutputChannel) {
...
`.trim();
  ...
  outputChannel.appendLine("convertUsingOllama: Prompt invoked, waiting for response");
...
export async function convertToKotlin(javaCode: string, outputChannel: vscode.OutputChannel): Promise<string> {
